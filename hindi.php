...
<table height="auto" width="100%">
 <tr>
 <th width="20%"><font color="#92C50D" size="5px">------Movie------</font></th>
 <th width="30%"><font color="#92C50D" size="5px">------Movie_Name------</font></th>
 <th width="30%"><font color="#92C50D" size="5px">------Movie_type------</font></th>
 <th width="20%"><font color="#92C50D" size="5px">------Price------</font></th>
 </tr>
 <hr style="position:relative;top:50px;">
<?php
$pro_select = "select * from movi_upload where movi_type='hindi'";
